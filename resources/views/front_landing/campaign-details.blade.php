                ...
                <div class="row pt-100">
                    <div class="col-xl-8 ">
                        ...
                        <div class="cause-desc mb-40">
                            <h3 class="fw-6 fs-26 text-dark mb-3">
                            ...
                            <div class="desc-box d-flex flex-wrap">
                                <div class="d-flex align-items-center me-lg-5 me-4">
                                    ...
                                    <p class="fs-16 fw-5 text-primary mb-0">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active mb-5" id="pills-home" role="tabpanel"
                                    ...
                                    <p class="fs-16 fw-5 text-dark mb-lg-4 mb-3">
                                        @if (App::getLocale() == 'AR' && $campaign->short_description_lang != null)
                                            {!! $campaign->short_description_lang['ar'] ??  '' !!}
                                        @elseif (App::getLocale() == 'TR' && $campaign->short_description_lang != null)
                                            {!! $campaign->short_description_lang['tr'] ??  '' !!}
                                        @else
                                ...
                                <p class="fs-16 fw-5 text-dark mb-lg-4 mb-3">
                                    ...
                                    @if (App::getLocale() == 'AR' && $campaign->description_lang != null)
                                        {!! $campaign->description_lang['ar'] ??  '' !!}
                                    @elseif (App::getLocale() == 'TR' && $campaign->description_lang != null)
                                        {!! $campaign->description_lang['tr'] ??  '' !!}
                                    @else
                        ...
                        <!-- end time-count-section -->
                            ...
                            <div class="news-right-section share bg-light p-30 rounded-10 mb-20 position-relative">
                                <div class="d-flex justify-content-between align-items-center mb-4 pb-lg-1">
                                    <h5 class="fs-20 fw-6 text-dark mb-0">{{__('messages.front_landing.social_share')}}</h5>
                                    <div class="rectangle-shape"></div>
                                </div>
                    ...
                    <span href="{{ route('landing.causes' , ['category' => $campaignCategory->id])}}"
                          data-id="{{$campaignCategory->id}}"
                          class="text-dark fs-16 fw-5 news-category-filter1">
                            @if (App::getLocale() == 'AR' && $campaignCategory->name_lang != null)
                                {{isset($campaignCategory) ? $campaignCategory->name_lang['ar'] : ''}}
                            @elseif (App::getLocale() == 'TR' && $campaignCategory->name_lang != null)
                                {{isset($campaignCategory) ? $campaignCategory->name_lang['tr'] : ''}}
                            @else
                                {{isset($campaignCategory) ? $campaignCategory->name : ''}}
                            @endif
                        </span>
