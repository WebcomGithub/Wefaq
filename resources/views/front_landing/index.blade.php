    ...
    <div class="home-page">
                                    ...
                                    <div class="card">
                                        <div class="positon-relative">
                                            ...
                                            class="badge small-btn {{ $campaign->is_emergency == 1 ? 'custom-cause-red' : ''}}">
                                                @if (App::getLocale() == 'AR' && $campaign->campaignCategory->name_lang != null)
                                                    {{ $campaign->campaignCategory->name_lang['ar'] ??  ''}}
                                                @elseif (App::getLocale() == 'TR' && $campaign->campaignCategory->name_lang != null)
                                                    {{ $campaign->campaignCategory->name_lang['tr'] ??  ''}}
                                                @else
                                                    <p class="fs-18 fw-5">{{ $campaign->campaignCategory->name }}</p>
                                                @endif
                                            </a>
                                            @php
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-dark fs-18 mb-3">
                                                ...
                                                href="{{ route('landing.campaign.details',$campaign->slug) }}">
                                                    @if (App::getLocale() == 'AR' && $campaign->title_lang != null)
                                                        {{ Str::limit($campaign->title_lang['ar'],50) ??  ''}}
                                                    @elseif (App::getLocale() == 'TR' && $campaign->title_lang != null)
                                                        {{ Str::limit($campaign->title_lang['tr'],50) ??  ''}}
                                                    @else
                        ...
                        <div class="col-xxl-6 col-xl-5 col-lg-4 mt-lg-0 mt-sm-5 mt-4">
                            <div class="about-right">
                                <h2 class="text-dark fw-6 mb-3 pb-1">
                                    @if (App::getLocale() == 'AR' && $data['aboutUs']['title_lang'] != null)
                                        {{ json_decode($data['aboutUs']['title_lang'], true)['ar'] }}
                                    @elseif (App::getLocale() == 'TR' && $data['aboutUs']['title_lang'] != null)
                                        {{ json_decode($data['aboutUs']['title_lang'], true)['tr'] }}
                                    @else
                                        {{ $data['aboutUs']['title'] }}
                                    @endif
                                ...
                                <p class="text-dark fs-16 fw-5 mb-4 pb-lg-3">
                                    ...
                                    @elseif (App::getLocale() == 'TR' && $data['aboutUs']['short_description_lang'] != null)
                                        {{ Str::words(strip_tags(json_decode($data['aboutUs']['short_description_lang'], true)['tr']), 100, '...') }}
                                    @else
                                        {{ Str::words(strip_tags($data['aboutUs']['short_description']), 100, '...') }}
                                    @endif
                                </p>                            {{-- <ul>
        ...
        <section id="media-gallery" dir="rtl" style="padding: 20px; background-color: #f9f9f9;">
            ...
            <div class="gallery-container">
                <img src="https://i.pinimg.com/736x/56/f3/12/56f312a5b648bb3ecd80d484ed22c847.jpg" alt="صورة 1" class="gallery-item">
                <img src="https://www.cairo24.com/Upload/libfiles/79/6/48.jpg" alt="صورة 2" class="gallery-item">
                ...
                <img src="https://i.pinimg.com/736x/56/f3/12/56f312a5b648bb3ecd80d484ed22c847.jpg" alt="صورة 3" class="gallery-item">
                <img src="https://www.cairo24.com/UploadCache/libfiles/79/6/600x338o/111.jpg" alt="صورة 4" class="gallery-item">
                <img src="https://i.pinimg.com/736x/56/f3/12/56f312a5b648bb3ecd80d484ed22c847.jpg" alt="صورة 4" class="gallery-item">
                <img src="https://i.pinimg.com/736x/56/f3/12/56f312a5b648bb3ecd80d484ed22c847.jpg" alt="صورة 4" class="gallery-item">
                <img src="https://www.cairo24.com/Upload/libfiles/79/6/47.jpg" alt="صورة 4" class="gallery-item">
                <img src="https://i.pinimg.com/736x/56/f3/12/56f312a5b648bb3ecd80d484ed22c847.jpg" alt="صورة 4" class="gallery-item">
                <img src="https://www.cairo24.com/Upload/libfiles/79/6/45.jpg" alt="صورة 4" class="gallery-item">
            </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body w-100">
                                             ...
                                             <!--    <iframe src="https://ummeti.mynet.net/video/ummeti1.mp4"
                                                        class="w-100 h-100"
