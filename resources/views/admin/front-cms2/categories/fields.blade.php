            ...
            <div class="mb-3" io-image-input="true">
                ...
                <div class="d-block">
                    <div class="image-picker">
                        <div class="image previewImage" id="exampleInputImage" style="background-image: url('{{ ($category['image_1']) ? $category['image_1'] : asset('assets/images/ummeti-logo.png') }}')">
                        </div>
    ...
    <div class="col-md-12 d-flex mb-7 mt-4">
        <div class="col-md-3">
            <div class="mb-3" io-image-input="true">
                ...
                <div class="d-block">
                    <div class="image-picker">
                        <div class="image previewImage" id="exampleInputImage" style=" background-image: url('{{ ($category['image_2']) ? $category['image_2'] : asset('assets/images/ummeti-logo.png') }}')">
                        </div>
                        <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                              data-placement="top" data-bs-original-title="Change Image">
                        <label> 
    ...
    <div class="col-md-12 d-flex mb-7 mt-4">
        <div class="col-md-3">
            <div class="mb-3" io-image-input="true">
                ...
                <div class="d-block">
                    <div class="image-picker">
                        <div class="image previewImage" id="exampleInputImage" style="background-image: url('{{ ($category['image_3']) ? $category['image_3'] : asset('assets/images/ummeti-logo.png') }}')">
                        </div>
                        <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                              data-placement="top" data-bs-original-title="Change Image">
                        <label> 
