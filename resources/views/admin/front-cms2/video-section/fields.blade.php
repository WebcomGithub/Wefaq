        ...
        <div class="mb-3" io-image-input="true">
            ...
            <div class="d-block">
                <div class="image-picker">
                    <div class="image previewImage" id="exampleInputImage" style=" background-image: url('{{ ($secondVideoSection['bg_image']) ? $secondVideoSection['bg_image'] : asset('assets/images/ummeti-logo.png') }}')">
                    </div>
