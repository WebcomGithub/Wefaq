<div class="row gx-10 mb-5">
    <div class="col-md-6 mb-5">
        {{ Form::label('title_1', __('messages.slider.title_1_ar').':', ['class' => ' form-label']) }}
        {{ Form::text('title_1_ar', isset($thirdSlider) && !empty($thirdSlider->title_1_lang) ? $thirdSlider->title_1_lang['ar'] : '', ['class' => 'form-control', 'placeholder' => __('messages.common.title')]) }}
    </div>
    <div class="col-md-6 mb-5">
    ...
    <div class="col-md-6 mb-5">
        {{ Form::label('title_1', __('messages.slider.title_1_tr').':', ['class' => ' form-label']) }}
        {{ Form::text('title_1_tr', isset($thirdSlider) && !empty($thirdSlider->title_1_lang) ? $thirdSlider->title_1_lang['tr'] : '', ['class' => 'form-control', 'placeholder' => __('messages.common.title')]) }}
    </div>
    ...
    <div class="col-md-6 mb-5">
     ...
     <div class="col-md-6 mb-5">
        ...
        {{ Form::text('title_2_ar', isset($thirdSlider) && !empty($thirdSlider->title_2_lang) ? $thirdSlider->title_2_lang['ar'] : '', ['class' => 'form-control', 'placeholder' => __('messages.common.title')]) }}
    </div>
    <div class="col-md-6 mb-5">
        {{ Form::label('title_2', __('messages.slider.title_2_tr').':', ['class' => ' form-label ']) }}
        {{ Form::text('title_2_tr', isset($thirdSlider) && !empty($thirdSlider->title_2_lang) ? $thirdSlider->title_2_lang['tr'] : '', ['class' => 'form-control', 'placeholder' => __('messages.common.title')]) }}
    </div>
