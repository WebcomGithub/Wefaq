<div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-5">
                                        ...
                                        {{ Form::text('title',isset($campaign) ? $campaign->title : '', ['class' => 'form-control ', 'placeholder' => __('messages.common.title'),'id' => 'campaignCreateTitle', 'required','maxLength'=>200]) }}
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-5">
 ...
 <i class="fa-solid fa-pen" id="profileImageIcon"></i></span>
                                ...
                                <div class="mb-5">
                                    ...
                                    <textarea name="description" id="description" rows="6"  class="form-control" >{!! $campaign->description !!}</textarea>
                                </div>
                            </div>
            ...
            <div class="tab-pane fade" id="addLang" role="tabpanel" aria-labelledby="add-basic-details-tab">
                {{ Form::open(['route' => ['campaigns.update.languages', $campaign->id],'files' => 'true']) }}
                @method('POST')
                @csrf
                    <div class="row">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-5">
                                    ...
                                    {{ Form::text('title_ar', isset($campaign) && !empty($campaign->title_lang) ? $campaign->title_lang['ar'] : '', ['class' => 'form-control', 'placeholder' => __('messages.common.title')]) }}
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-5">
                                    ...
                                    {{ Form::text('title_tr', isset($campaign) && !empty($campaign->title_lang) ? $campaign->title_lang['tr'] : '', ['class' => 'form-control', 'placeholder' => __('messages.common.title')]) }}
                                </div>
                            </div>

                            <div class="col-lg-12">
                                <div class="mb-5">
                                    {{ Form::label('short_description', __('messages.common.short_description_ar') . ':', ['class' => 'form-label']) }}
                                    {{ Form::textarea(
                                        'short_description_ar',
                                        isset($campaign) && !empty($campaign->short_description_lang) ? $campaign->short_description_lang['ar'] : '',
                                        ['class' => 'form-control', 'placeholder' => __('messages.common.short_description'), 'rows' => '5', 'maxLength' => 500]
                                    ) }}
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-5">
                                    {{ Form::label('short_description', __('messages.common.short_description_tr').':', ['class' => 'form-label']) }}
                                    {{ Form::textarea(
                                        'short_description_tr',
                                        isset($campaign) && !empty($campaign->short_description_lang) ? $campaign->short_description_lang['tr'] : '',
                                        ['class' => 'form-control', 'placeholder' => __('messages.common.short_description'), 'rows' => '5', 'maxLength' => 500]
                                    ) }}
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-5">
                                    {{-- {{ Form::textarea(
                                        'description_ar',
                                        isset($campaign) && !empty($campaign->description_lang) ? $campaign->description_lang['ar'] : '',
                                        ['class' => 'form-control']
                                    ) }} --}}
