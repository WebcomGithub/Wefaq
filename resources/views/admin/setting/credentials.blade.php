            ...
            <div class="card mb-5 mb-xl-10">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 d-flex align-items-center">
                                <span class="text-gray-900 fs-3 my-3">{{ __('messages.setting.Cash') }}</span>
                                <label class="form-check form-switch form-check-custom form-switch-sm ms-3">
                                    <input type="checkbox" name="" class="form-check-input" disabled value="1">
                                </label>
                            </div>

                            <div class="col-12 d-flex align-items-center">
                                <span class="text-gray-900 fs-3 my-3">{{ __('messages.setting.Check') }}</span>
                                <label class="form-check form-switch form-check-custom form-switch-sm ms-3">
                                    <input type="checkbox" name="" class="form-check-input" disabled value="1">
                                </label>
                            </div>
                            ...
                            <div class="col-12 d-flex align-items-center">
                                <span class="text-gray-900 fs-3 my-3">{{ __('messages.setting.Bank transfer') }}</span>
                                <label class="form-check form-switch form-check-custom form-switch-sm ms-3">
                                    <input type="checkbox" name="" class="form-check-input" disabled value="1">
                                </label>
                            </div>
                            ...
                            <div class="col-12 d-flex align-items-center">
                                <span class="text-gray-900 fs-3 my-3">{{ __('messages.setting.Crypto') }}</span>
                                <label class="form-check form-switch form-check-custom form-switch-sm ms-3">
                                    <input type="checkbox" name="" class="form-check-input" disabled value="1">
                                </label>
                            </div>
                            ...
                            <div class="col-12 d-flex align-items-center">
                                <span class="text-gray-900 fs-3 my-3">{{ __('messages.setting.Google Pay') }}</span>
                                <label class="form-check form-switch form-check-custom form-switch-sm ms-3">
                                    <input type="checkbox" name="" class="form-check-input" disabled value="1">
                                </label>
                            </div>
                            ...
                            <div class="col-12 d-flex align-items-center">
                                <span class="text-gray-900 fs-3 my-3">{{ __('messages.setting.Apple Pay') }}</span>
                                <label class="form-check form-switch form-check-custom form-switch-sm ms-3">
                                    <input type="checkbox" name="" class="form-check-input" disabled value="1">
                                </label>
                            </div>
