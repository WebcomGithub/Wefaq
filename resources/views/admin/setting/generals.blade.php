            ...
            <div class="card mb-5 mb-xl-10 border-0 px-10">
                ...
                <div class="collapse show">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-5">
                            {{ Form::label('about_us', __('messages.setting.about_us_ar').':', ['class' => 'form-label required']) }}
{{--
                            {{ Form::textarea('about_us_ar', json_decode($setting['about_us_lang'], true)['ar'], ['class' => 'form-control', 'required', 'placeholder' => __('messages.setting.about_us'), 'maxLength'=>5000]) }}
                                ...
                                <div class="d-block">
                                    <div class="image-picker">
                                        <div class="image previewImage" id="faviconPreview"
                                             style="background-image: url('{{ ($setting['app_favicon']) ? asset($setting['app_favicon']): asset('assets/images/ummeti-logo.png') }}')">
                                        </div>
                                        <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                              data-bs-toggle="tooltip"
