...
//    });
    ...
    Route::middleware('permission:manage_campaign')->group(function () {
        ...
        Route::post('test-save', [CampaignController::class, 'testSave'])->name('test.save');
        Route::post('campaigns/{id}/edit/languages', [CampaignController::class, 'updateLanguages'])->name('campaigns.update.languages');
        ...
        Route::put('campaign-categories-edit',
        [CampaignCategoryController::class, 'updateCategory'])->name('campaign.categories.edit');
        Route::post('campaign-categories-status',
            [CampaignCategoryController::class, 'changeCategoryStatus'])->name('campaign-categories.status');
