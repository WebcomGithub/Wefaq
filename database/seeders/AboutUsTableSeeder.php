...
class AboutUsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (! AboutUs::where('key', 'menu_title_lang')->exists()) {
            AboutUs::create(['key' => 'menu_title_lang', 'value' => '']);
        }
        ...
        if (! AboutUs::where('key', 'title_lang')->exists()) {
            AboutUs::create(['key' => 'title_lang', 'value' => '']);
        }
        ...
        if (! AboutUs::where('key', 'short_description_lang')->exists()) {
            AboutUs::create(['key' => 'short_description_lang', 'value' => '']);
        }
